...
export default function FeaturesSection() {
    return (
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Features" text2="Why use our generator?" text3="Create stunning thumbnails in seconds." />
            ...
            <div className="mt-40 relative mx-auto max-w-5xl " id="about">
                ...
                >
                   Our AI stands your content and generates thumbnails that are not only visually stunning but also optimized for maximum engagement across all platforms.
                </motion.p>
                <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
                    ...
                    >
                        ...
                        <h3 className="text-[24px]/7.5 text-slate-300 font-medium mt-6">Boost your views with AI-generated thumbnails</h3>
                        <p className="text-slate-300 mt-2">Stop guessing and start ranking. Our AI creates designs proven to capture attention and drive engagement.</p>
