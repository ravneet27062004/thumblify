      ...
      <div className={`relative overflow-hidden ${aspectClasses[aspectRatio]}`}>
       ...
       <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 bg-black/25">
        ...
        <div className="text-center">
            ...
            <p className="text-xs text-zinc-400 mt-1">This may take a few moments.</p>
        </div>
        </div>
       )}
       {/* image preview */}
       {!isLoading && thumbnail?.image_url && (
        <div className="group group-relative h-full w-full">
...
<div className="flex max-sm:hidden size-20  items-center justify-center rounded-full bg-white/10">
